      ...
      <section className="py-20 section-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>
              Kişisel verilerinizin, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) uyarınca, veri sorumlusu sıfatıyla, İKAR İNŞAAT tarafından hangi kapsamda işlenebileceği aşağıda açıklanmıştır.
            </p>
            ...
            <ul>
              ...
              <li>Şirketimizin iş ilişkisi içerisinde olunan gerçek ve tüzel kişilerin, ticari ve hukuki emniyetinin sağlanması,</li>
              <li>Şirketimizin oluşturduğu ticari itibarının ve güvenin korunması,</li>
              <li>Sağlığa ilişkin özel nitelikli kişisel veriler ise ancak mevzuattan/sözleşmeden kaynaklı hijyen kurallarına uymak amacıyla işlenebilmektedir.</li>
            </ul>
